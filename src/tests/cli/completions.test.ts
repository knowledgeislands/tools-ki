...
describe('[ki completions]', () => {
  test('renders zsh and bash completion scripts', async () => {
    ...
    expect(zsh.output).toContain("_values 'repository command' audit conform diag educate list plan register skill upgrade")
    ...
    expect(bash.output).toContain('compgen -W "audit conform diag educate list plan register skill upgrade"')
