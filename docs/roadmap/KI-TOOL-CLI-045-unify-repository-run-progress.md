...
- [ ] Decide whether a long indeterminate evidence stage should keep the unbounded animated sweep or show elapsed time against a typical duration, and apply one answer to both commands.
