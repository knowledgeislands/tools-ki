...
Without either selector, the direct-CWD workspace default is selected before a direct-CWD `.mgit.toml`; then ordinary one-repository discovery remains the fallback.
